# Django settings for LHLunchWebGUI project.
...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(SITE_ROOT, 'db', 'test.db'),                      # Or path to database file if using sqlite3.
...
SECRET_KEY = 'j@3712f1h&amp;nxu3ij!*9wmebpl*0i9i!zh%0sy9@5@snlcjyh07'
...
WSGI_APPLICATION = 'LHLunchWebGUI.wsgi.application'
